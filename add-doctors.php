            ...
            <div class="row g-0">
              <div class="col-lg-12">
				...
				<form class="add-patient-forms" action="javascript:void();" method="post">
                  <h3 class="form-title mb-3">Add Doctors</h3>
				                      <div class="form-group row">
                                          <div class="col-sm-6">
                                          <input type="text" class="form-control" id="patientname" placeholder="Doctor name">
										  </div>
										  <div class="col-sm-6">
                      ...
                      <div class="form-group row">
									  <div class="col-sm-12 text-black" >
                                        <textarea type="text" class="form-control h-80" id="anynotes" placeholder="About Doctors"></textarea>
                                      </div>
								    </div>
								    <div class="form-group row">
									  <div class="col-sm-12 text-black">
