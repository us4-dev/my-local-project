        ...
        <div class="card card-registration card-registration-2" style="border-radius: 15px;">
          <div class="card-body p-0">
            <div class="row g-0">
              <div class="col-lg-12">
                <div class="p-4">
                  <h3 class="form-title mb-3">visa invitation letter</h3>
				      
                      <div class="form-group row">
                            <div class="col-sm-12">
                                <div class="title_attendant">Patient Details</div>
					  ...
					  <div id="add_more_option" style="display: block;">
                          <div class="form-group row">
                            <div class="col-sm-12">
					...
					<div class="form-group row">
                            ...
                            <textarea type="text" class="form-control h-80" placeholder="Any comments regarding treatment procedure?"></textarea>
                            </div>
                    </div> 
					<div class="form-group row">
                            <div class="col-sm-12">
					...
					<div class="form-group row">
                            <div class="col-sm-12">
							 <textarea type="text" class="form-control h-80" placeholder="Hotel Address"></textarea>
							</div>
                    </div> 
					
					<div class="form-group row">
                            <div class="col-sm-12">
							<label><b>Translator Detail</b></label>
								<input type="text" class="form-control" id="hotelname" placeholder="Translator Name">
							</div>
                    </div> 
					<div class="form-group row">
                            <div class="col-sm-12">
							 <input type="text" class="form-control" id="tmobno" placeholder="Mobile number">
							</div>
                    </div>
                    ...
                    <div id="add_more_option2">
						...
						<div class="form-group row">
						  <div class="col-sm-12 text-black">
						   <button type="submit" class="btn btn-primary me-2">Submit Query</button>
						  </div>
						</div>					
                    <style>
