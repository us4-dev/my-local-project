                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                      <div class="serviceBox">
                          ...
                          <p class="description"><b>Treatment:</b> Spine Surgery</p>
                          ...
                          <p class="read-more"><a href="patient-profile-details.php">read more <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></p>
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <img src="assets/images/patient-img/pic-2.jpg">
                            ...
                            <p class="read-more"><a href="#">read more <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></p>
                            <p class="description contact-via"><b>Contact via:</b>  <a href="#"><i class="fa fa-whatsapp"></i></a>
                            <a href="#"><i class="fa fa-phone"></i></a> <a href="#"><i class="fa fa-envelope"></i></a>
                            <a href="#"><i class="fa fa-comment"></i></a>
                          </p>
